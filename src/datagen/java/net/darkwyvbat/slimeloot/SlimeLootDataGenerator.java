                                                ...
                                                LootPool.lootPool()
                                                        ...
                                                        .add(NestedLootTable.inlineLootTable(
                                                                LootTable.lootTable()
                                                                        ...
                                                                        .withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.COAL)).setRolls(UniformGenerator.between(1.0F, 3.0F)))
                                                                        .withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.IRON_INGOT)).setRolls(UniformGenerator.between(0.0F, 1.0F)))
